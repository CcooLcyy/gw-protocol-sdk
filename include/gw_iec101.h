...
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec101_counter_interrogation(
    iec_session_t *session,
    const iec_counter_interrogation_request_t *request);
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec101_control_point(
    iec_session_t *session,
...
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec101_read_clock(
    ...
    uint32_t *out_request_id);
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec101_read_parameters(
    iec_session_t *session,
    const iec_parameter_read_request_t *request,
    uint32_t *out_request_id);
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec101_write_parameters(
    iec_session_t *session,
    const iec_parameter_write_request_t *request,
    uint32_t *out_request_id);
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec101_verify_parameters(
    iec_session_t *session,
    const iec_parameter_verify_request_t *request,
    uint32_t *out_request_id);
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec101_switch_setting_group(
    iec_session_t *session,
    const iec_setting_group_request_t *request,
    uint32_t *out_request_id);
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec101_get_device_description(
    iec_session_t *session,
...
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec101_cancel_file_transfer(
    iec_session_t *session,
    uint32_t transfer_id);
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec101_upgrade_firmware(
    iec_session_t *session,
    const iec_upgrade_request_t *request,
    uint32_t *out_upgrade_id);
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec101_cancel_upgrade(
    iec_session_t *session,
    uint32_t upgrade_id);
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec101_set_option(
    ...
    const void *value,
    uint32_t value_size);
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec101_send_raw_asdu(
    iec_session_t *session,
