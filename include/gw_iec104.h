...
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec104_create(
...
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec104_destroy(iec_session_t *session);
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec104_get_runtime_state(
...
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec104_control_point(
    iec_session_t *session,
...
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec104_read_point(
    iec_session_t *session,
    const iec_point_address_t *address);
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec104_clock_sync(
    iec_session_t *session,
...
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec104_list_files(
    ...
    uint32_t *out_request_id);
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec104_read_file(
    iec_session_t *session,
    const iec_file_read_request_t *request,
    uint32_t *out_transfer_id);
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec104_write_file(
    iec_session_t *session,
    const iec_file_write_request_t *request,
    uint32_t *out_transfer_id);
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec104_get_file_transfer_status(
    const iec_session_t *session,
    uint32_t transfer_id,
    iec_file_transfer_status_t *out_status);
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec104_cancel_file_transfer(
    iec_session_t *session,
    uint32_t transfer_id);
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec104_upgrade_firmware(
    iec_session_t *session,
    const iec_upgrade_request_t *request,
    uint32_t *out_upgrade_id);
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec104_cancel_upgrade(
    iec_session_t *session,
    uint32_t upgrade_id);
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec104_set_option(
    ...
    const void *value,
    uint32_t value_size);
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec104_send_raw_asdu(
    iec_session_t *session,
    const iec_raw_asdu_tx_t *request);
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec104_start(iec_session_t *session);
GW_PROTOCOL_API iec_status_t GW_PROTOCOL_CALL iec104_stop(iec_session_t *session, uint32_t timeout_ms);
