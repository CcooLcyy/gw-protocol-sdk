...
GW_PROTOCOL_EXPORT iec_status_t GW_PROTOCOL_CALL m101_validate_config(const m101_master_config_t *config)
{
    return gw::protocol::validate_m101_config(config);
}

GW_PROTOCOL_EXPORT iec_status_t GW_PROTOCOL_CALL m101_create(
    ...
    iec_session_t **out_session)
{
    return gw::protocol::create_session(
        gw::protocol::Profile::M101, config, protocol_config, transport, callbacks, out_session);
}

GW_PROTOCOL_EXPORT iec_status_t GW_PROTOCOL_CALL m101_destroy(iec_session_t *session)
{
    return gw::protocol::destroy_session(session);
}

GW_PROTOCOL_EXPORT iec_status_t GW_PROTOCOL_CALL m101_get_runtime_state(
...
GW_PROTOCOL_EXPORT iec_status_t GW_PROTOCOL_CALL m101_general_interrogation(
...
GW_PROTOCOL_EXPORT iec_status_t GW_PROTOCOL_CALL m101_counter_interrogation(
    iec_session_t *session,
...
GW_PROTOCOL_EXPORT iec_status_t GW_PROTOCOL_CALL m101_clock_sync(
    iec_session_t *session,
...
GW_PROTOCOL_EXPORT iec_status_t GW_PROTOCOL_CALL m101_read_clock(
    iec_session_t *session,
...
GW_PROTOCOL_EXPORT iec_status_t GW_PROTOCOL_CALL m101_read_file(
    iec_session_t *session,
...
GW_PROTOCOL_EXPORT iec_status_t GW_PROTOCOL_CALL m101_write_file(
    iec_session_t *session,
...
GW_PROTOCOL_EXPORT iec_status_t GW_PROTOCOL_CALL m101_get_file_transfer_status(
    const iec_session_t *session,
...
GW_PROTOCOL_EXPORT iec_status_t GW_PROTOCOL_CALL m101_send_raw_asdu(
    iec_session_t *session,
...
GW_PROTOCOL_EXPORT iec_status_t GW_PROTOCOL_CALL m101_start(iec_session_t *session)
{
    return gw::protocol::start_session(session);
}

GW_PROTOCOL_EXPORT iec_status_t GW_PROTOCOL_CALL m101_stop(iec_session_t *session, uint32_t timeout_ms)
{
