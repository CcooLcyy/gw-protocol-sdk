...
GW_PROTOCOL_EXPORT iec_status_t GW_PROTOCOL_CALL iec101_read_parameters(
    iec_session_t *session,
...
GW_PROTOCOL_EXPORT iec_status_t GW_PROTOCOL_CALL iec101_write_parameters(
    iec_session_t *session,
...
GW_PROTOCOL_EXPORT iec_status_t GW_PROTOCOL_CALL iec101_verify_parameters(
    iec_session_t *session,
...
GW_PROTOCOL_EXPORT iec_status_t GW_PROTOCOL_CALL iec101_switch_setting_group(
    iec_session_t *session,
...
GW_PROTOCOL_EXPORT iec_status_t GW_PROTOCOL_CALL iec101_get_device_description(
    iec_session_t *session,
...
GW_PROTOCOL_EXPORT iec_status_t GW_PROTOCOL_CALL iec101_upgrade_firmware(
    iec_session_t *session,
...
GW_PROTOCOL_EXPORT iec_status_t GW_PROTOCOL_CALL iec101_cancel_upgrade(
    iec_session_t *session,
    uint32_t upgrade_id)
{
